...
<ol>
  <li><img style="border: 5px black; float: left;" src="./arquivos_de_apoio/tutorial_download_images/botao_verde.png" alt=""></li>
  <li><img style="border: 5px black; float: left;" src="./arquivos_de_apoio/tutorial_download_images/botao_download.png" alt=""></li>
</ol>
<hr>
Sistema automático de devolução de produtos usando planilhas.
<hr>
