...
$(function () {
    ...
    $.widget("primeui.puidatatable", {
        ...
        _createScrollableDatatable: function () {
            ...
            //fix-multiple selecteds
            this.tbody.addClass('pui-datatable-data');
                    ...
                    if (rowData) {
                        ...
                        for (var j = 0; j < this.options.columns.length; j++) {
                            ...
                            if (columnOptions.content) {
                                var content = columnOptions.content.call(rowIndex, rowData);
                                ...
                                var str = this._objectPath(rowData, columnOptions.field);
                                column.text(str);
                            }
                        }
                    }
        ...
        getScrollbarWidth: function () {
            if (!this.scrollbarWidth) {
                this.scrollbarWidth = PUI.calculateScrollbarWidth(); // sempre calcular o tamanho da barra
            }
            return this.scrollbarWidth;
        },
        ...
        loadExpandedRowContent: function (row) {
            ...
            for (var j = 0; j < this.options.columns.length; j++) {
                ...
                if ((columnOptions.bodyClass && columnOptions.bodyClass.includes('visibility: hidden')) ||
                    (columnOptions.headerClass && columnOptions.headerClass.includes('visibility: hidden'))) {
                    colspan -= 1;
                }                           
            }
            var expandedRow = $('<tr class="ui-expanded-row-content ui-datatable-unselectable ui-widget-content"><td colspan="' + colspan + '"></td></tr>');
...
$(function () {
    ...
    $.widget("primeui.puipicklist", {
        ...
        removeItemSelected() {
            ...
            items.hide().removeClass('ui-state-highlight ui-state-hover');
            items.remove();

            items = this.targetList.children('li.pui-picklist-item.ui-state-highlight');
            items.hide().removeClass('ui-state-highlight ui-state-hover');
            items.remove();
